...
public class CriminalValidatorServiceWrapper {
    ...
    @Async
    public CompletableFuture<Boolean> validateCriminalRegistry(Lead candidate) {
        ...
        logger.debug("USING EXTERNAL CRIMINAL VALIDATOR SERVICE");
        ...
        Boolean validation = new
                ...
                "/thirdparty/criminalvalidator/validateRegistry", request, Boolean.class);
